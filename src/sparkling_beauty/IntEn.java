...
public class IntEn {
	...
	public static void main(String[] args) {
		...
		File input = new File("/Users/uzini/Desktop/Sparkling Beauty/int_en/Sparkling Beauty.html");
		try {
			//스파클링 뷰티 html 문서 불러오기
			Document doc = Jsoup.parse(input, "UTF-8", "https://www.laneige.com/int/en/sparkling-beauty.html");
