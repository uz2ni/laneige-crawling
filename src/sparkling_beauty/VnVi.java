...
public class VnVi {
	...
	public static void main(String[] args) {
		...
		File input = new File("/Users/uzini/Desktop/Sparkling Beauty/vn_vi/Sparkling Beauty.html");
		try {
			//스파클링 뷰티 html 문서 불러오기
			Document doc = Jsoup.parse(input, "UTF-8", "https://www.laneige.com/vn/vi/sparkling-beauty.html");
	        ...
	        try {
	            FileOutputStream fileoutputstream = new FileOutputStream("/Users/uzini/Desktop/Sparkling Beauty/vn_vi/vn_vi_data.xlsx");
