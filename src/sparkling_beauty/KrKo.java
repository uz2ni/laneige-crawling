...
public class KrKo {
	...
	public static void main(String[] args) {
		...
		File input = new File("/Users/uzini/Desktop/Sparkling Beauty/kr_ko/Sparkling Beauty.html");
		try {
			//스파클링 뷰티 html 문서 불러오기
			Document doc = Jsoup.parse(input, "UTF-8", "https://www.laneige.com/kr/ko/sparkling-beauty.html");
	        ...
	        try {
	            FileOutputStream fileoutputstream = new FileOutputStream("/Users/uzini/Desktop/Sparkling Beauty/kr_ko/kr_ko_data.xlsx");
